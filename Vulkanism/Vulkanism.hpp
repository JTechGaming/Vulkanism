...
namespace Vulkanism {
    ...
    public:
        ...
        friend std::ostream& operator<<(std::ostream& os, const Transform& transform) {
            return os << "Loc: " << transform.position << " , Rot: " << transform.rotation << " , Scale: " << transform.scale << '\n';
        }
    };
}

using namespace Vulkanism;
...
inline int main(int argc, char* argv[]) {
    ...
    Mat<double, 3, 3> testMat4 = Mat<double, 3, 3>(1.0, 2.0, 6.0, 1.0, 0.0, 4.0, 1.5, 6.0, 1.0);
